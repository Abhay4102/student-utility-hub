...
export default function PngToPdf() {
  ...
  function handleFile(f: File) { setFile(f); setPdfUrl(null); setPreview(URL.createObjectURL(f)); }
  ...
  return (
    <ToolLayout
      title="PNG to PDF"
      description="Convert PNG images into PDF documents"
      ...
      <div className="space-y-4">
        {!file ? (
          ...
          <div className="bg-card border border-card-border rounded-xl p-5 space-y-4">
            {preview && <div className="flex justify-center"><img src={preview} alt="Preview" className="max-h-48 rounded-lg object-contain shadow-sm" /></div>}
